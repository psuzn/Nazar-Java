...
public class ImageUtils {
    static {
        try {
            Log.d("Nazar_Debug","Library Loading" );
            System.loadLibrary("image-utils");
            Log.d("Nazar_Debug","Library Loaded" );
        } catch (UnsatisfiedLinkError e) {
            Log.d("Nazar_Debug","Native library not found, native RGB -> YUV conversion may be unavailable.");
        }
    };
    ...
    public static void saveBitmap(final Bitmap bitmap, final String filename) {
        ...
        Log.d("Nazar_Debug","saving at :"+root);
        if(!myDir.exists())
            if (!myDir.mkdirs()) {
                Log.d("Nazar_Debug","Make dir failed");
            }
        ...
        try {
            ...
            Log.e("Nazar_Debug",e.toString());
        }
        Log.d("Nazar_Debug","saved at :"+root);
    }
